...
class _TrackingMapWidgetState extends State<TrackingMapWidget> {
      ...
      child: Stack(
        children: [
          GoogleMap(
            ...
            initialCameraPosition: CameraPosition(target: _deliveryBoyLatLng, zoom: 18),
            ...
            onMapCreated: (GoogleMapController controller) {
              ...
              _isLoading = false;
              setMarker();
              controller.getVisibleRegion().then((value) => print(value.toString()));
            },
            onTap: (latLng) async {
  ...
  void setMarker() async {
    print("Set Markers");
    Uint8List addressImageData = await convertAssetToUnit8List(Images.address_marker, width: 100);
    ...
    for(OrderModel order in Provider.of<OrderProvider>(context,listen: false).currentOrders){
      _markers.add(Marker(
        ...
        infoWindow: InfoWindow(
          ...
          snippet: '${order.deliveryAddress.latitude}, ${order.deliveryAddress.longitude}',
        ),
